...
español en el código. De 8.064 términos, **~60 salían en inglés**;
quedan **2 (una expresión de plantilla de SITEF y la palabra «Error»)**, y ninguno es una etiqueta: son fragmentos de código,
